...
namespace rubinius {
  ...
  struct Globals {
    ...
    TypedRoot<Class*> compiled_code, optimized_code, tuple, module, basicobject, object, array;
    ...
    TypedRoot<Class*> optimized_call_site;
