namespace :jit do
  task :generate_header do
    ...
    `llvm-as-3.2 < vm/llvm/types32.ll > vm/gen/types32.bc`
    `llvm-as-3.2 < vm/llvm/types64.ll > vm/gen/types64.bc`
    `llc-3.2 -march=cpp -cppgen=contents -o vm/llvm/types32.cpp.gen vm/gen/types32.bc`
    `llc-3.2 -march=cpp -cppgen=contents -o vm/llvm/types64.cpp.gen vm/gen/types64.bc`
  end
