  ...
  def __run__()
    begin
      begin
        ...
        begin
          # We must acquire @lock in a careful way.
          #
          ...
          # absolutely must make sure to acquire @lock as soon as possible to
          ...
          # Now, we acquired @lock. No other thread can interrupt this
          # thread anymore.
